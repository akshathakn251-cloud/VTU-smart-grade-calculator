      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-panel rounded-3xl p-8 shadow-xl flex flex-col justify-between relative overflow-hidden">
           ...
           <div className="flex gap-3 mt-6">
             <button className="flex-1 flex items-center justify-center gap-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 py-2.5 rounded-xl text-sm font-bold transition-colors border border-indigo-100">
                <Share2 className="h-4 w-4" /> Share
             </button>
             <button className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-gray-100 text-gray-700 py-2.5 rounded-xl text-sm font-bold transition-colors border border-gray-200">
